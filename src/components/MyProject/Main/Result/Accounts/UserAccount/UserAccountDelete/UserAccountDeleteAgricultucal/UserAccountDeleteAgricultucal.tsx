...
import "./user-account-delete-agricultucal.scss";

const UserAccountDeleteAgricultucal = (props: {
    elem: {
        name: any;
        model: any;
        year: any;
    ...
    const [delUrl, setDelUrl] = useState(`http://localhost:3000/agricultural/${id}`);
...
export default UserAccountDeleteAgricultucal;
