...
import "./user-account-delete-boat.scss";

const UserAccountDeleteBoat = (props: {
    elem: {
        name: any;
        model: any;
        year: any;
    ...
    const [delUrl, setDelUrl] = useState(`http://localhost:3000/boat/${id}`);
...
export default UserAccountDeleteBoat;
