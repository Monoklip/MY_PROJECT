...
import "./user-account-delete-trailer.scss";

const UserAccountDeleteTrailer = (props: {
    elem: {
        name: any;
        model: any;
        year: any;
    ...
    const [delUrl, setDelUrl] = useState(`http://localhost:3000/trailer/${id}`);
...
export default UserAccountDeleteTrailer;
