...
import "./user-account-delete-machinery.scss";

const UserAccountDeleteMachinery = (props: {
    elem: {
        name: any;
        model: any;
        year: any;
    ...
    const [delUrl, setDelUrl] = useState(`http://localhost:3000/machinery/${id}`);
...
export default UserAccountDeleteMachinery;
