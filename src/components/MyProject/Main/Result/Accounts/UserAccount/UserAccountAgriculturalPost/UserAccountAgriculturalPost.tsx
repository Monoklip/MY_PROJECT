import "./user-account-agricultural-post.scss";
...
const UserAccountAgriculturalPost = (props: { dataUser: { login: string } }) => {
    ...
    const [urlUsers, setUrlUsers] = useState("http://localhost:3000/cars");

    async function postUserCar() {
        try {
            if (
                postCarName !== "none" &&
                postCarModal !== "all" &&
...
export default UserAccountAgriculturalPost;
