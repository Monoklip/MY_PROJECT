...
import './admin-account-truck-delete-item.scss';

const AdminAccountTruckDeleteItem = (props: {
    elem?: any;
    nameAutoDel?: any;
    modelAutoDel?: any;
}) => {
    ...
    const [delUrl, setDelUrl] = useState(`http://localhost:3000/truck/${id}`);
...
export default AdminAccountTruckDeleteItem;
